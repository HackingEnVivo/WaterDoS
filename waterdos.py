...
def usage():
    print "./waterdos.py -t <target> [-r <threads> -p <port> -T -h]"
    print " -t|--target <Server EX: http://google.com>"
    print " -r|--POST emulations <Number of emulations> Defaults to 256"
    print " -p|--port <Server Port> Defaults to 80"
    print " -T|--tor Enable tunneling via TOR on 127.0.0.1:9050"
    print " -h|--help Shows This" 
    print "Eg. ./waterdos.py -t 192.168.1.100 -r 256"
...
if __name__ == "__main__":
    print "\n/*"
    print " *"+term.RED + " WaterDoS - A more effecient POST DoS tool! "+term.NORMAL
    print " * Slow HTTP POST Server Load Testing Tool"
    print " * Created By Watertower"
    print " * Route Through Tor"
    print " * I am not responsilbe for misuse of this tool."
    print " */\n"
